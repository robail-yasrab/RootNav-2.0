...
class MultiHourglass(nn.Module):
    def __init__(self, num_feats, num_blocks, input_channels, output_channels):
        ...
        #self.core_hourglass1 = Hourglass(256, 128, 4)
        #self.core_hourglass2 = Hourglass(128, 128, 4)
        self.tail_res0 = ResBlock(num_feats, 128) 
        self.tail_res00 = ResBlock(128, 128) 


        self.tail_deconv1 = nn.ConvTranspose2d(128, 128, 4, 2, 1, bias=False)
        self.tail_bn1 = nn.BatchNorm2d(128)
        


        self.tail_res1 = ResBlock(128, 128)
        #self.tail_res1_1 = ResBlock(128, 64)


        self.init_conv_union =  nn.Conv2d(256, 128, kernel_size=1, stride=1, padding=0)
        self.init_bn_union = nn.BatchNorm2d(128)
        self.tail_resx = ResBlock(128, 128)
        ...
        #self.init_conv_union1 =  nn.Conv2d(320, 64, kernel_size=1, stride=1, padding=0)
        #self.init_bn_union1 = nn.BatchNorm2d(64)
        #self.rtail_deconv2 = nn.ConvTranspose2d(128, 64, 4, 2, 1, bias=False)
        #self.rtail_bn2 = nn.BatchNorm2d(64)
        
        #self.rtail_res2 = ResBlock(64, 64)
        self.rtail_res2_2 = ResBlock(64, 64)
        #self.rtail_res2_3 = ResBlock(32, 32)
        

        #self.init_conv3 =  nn.Conv2d(32, 4, kernel_size=1, stride=1, padding=0)
        self.init_conv4 =  nn.Conv2d(64, 4, kernel_size=1, stride=1, padding=0)
